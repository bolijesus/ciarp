...
<body class="theme-teal">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('inicio') }}">COMITE INTERNO DE ASIGNACIÓN Y RECONOCIMIENTO DE
                    PUNTAJE - {{ config('app.name') }}</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <ul class="list">
                    ...
                    @if (session()->exists('MOD_SOLICITUD'))
                        @if ($location == 'solicitud')
                            <li class="active"><a href="{{ route('admin.solicitud') }}"><i
                                        class="material-icons">view_list</i><span>Solicitudes</span></a></li>
                        @else
                            <li><a href="{{ route('admin.solicitud') }}"><i
                                        class="material-icons">view_list</i><span>Solicitudes</span></a></li>
                        @endif
                    @endif
                    @if (session()->exists('MOD_PQR'))
                        @if ($location == 'pqr')
                            <li class="active"><a href="{{ route('admin.pqr') }}"><i
                                        class="material-icons">forum</i><span>Pqr</span></a></li>
                        @else
                            <li><a href="{{ route('admin.pqr') }}"><i
                                        class="material-icons">forum</i><span>Pqr</span></a></li>
                        @endif
                    @endif
                    @if (session()->exists('MOD_REPORTE'))
                        @if ($location == 'reporte')
                            <li class="active"><a href="{{ route('admin.reporte') }}"><i
                                        class="material-icons">assessment</i><span>Reportes</span></a></li>
                        @else
                            <li><a href="{{ route('admin.reporte') }}"><i
                                        class="material-icons">assessment</i><span>Reportes</span></a></li>
                        @endif
                    @endif
                    <li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2019 CIARP. Todos los Derechos Reservados. <a href="javascript:void(0);">AdminBSB - Material
                        Design</a>.
                </div>
                <div class="version">
