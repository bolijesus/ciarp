...
<ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
    ...
    <li class="active"><a href="{{route('libro.index')}}">Libros</a></li>
</ol>
@endsection
@section('content')
        ...
        <div class="card">
                ...
                <ul class="header-dropdown m-r--5">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="{{ route('libro.create') }}">Agregar Nueva Solicitud</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div class="body">
                <div class="alert bg-green alert-dismissible" role="alert">
                    ...
                    <strong>Detalles: </strong>Gestione la productividad académica de tipo Libro</div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('libro.edit',$d->id)}}" class="btn bg-indigo waves-effect btn-xs" data-toggle="tooltip" data-placement="top" title="Editar Solicitud"><i class="material-icons">mode_edit</i></a>
                                    ...
                                    <a href="{{ route('libro.delete',$d->id)}}" class="btn bg-red waves-effect btn-xs" data-toggle="tooltip" data-placement="top" title="Eliminar Solicitud"><i class="material-icons">delete</i></a>
