...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                    GESTIÓN DE FECHAS DE CIERRE - AGREGAR NUEVA FECHA
                </h2>
            </div>
            <div class="body">
                <div class="alert bg-green alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                    <strong>Agregue nuevas fechas.</strong> Gestione las fechas de cierre del sistema las cuales seran el plazo limite para los docentes realizar sus solicitudes. Recuerde de que solo una fecha puede estar en estado ACTIVA.
                </div>
                <div class="col-md-12">
                    @component('layouts.errors')
                    @endcomponent
                </div>
                <h1 class="card-inside-title">DATOS DE LA FECHA DE CIERRE</h1>
                <div class="row clearfix">
                    <div class="col-md-12">
                        {!! Form::open(['route'=>'fecha.store','method'=>'POST','class'=>'form-horizontal'])!!}
                        <div class="col-md-12">
