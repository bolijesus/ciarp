...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2>
                    GESTIÓN DE FECHAS DE PQR - EDITAR FECHA
                </h2>
            </div>
            <div class="body">
                <div class="alert bg-green alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>
                    <strong>Edite los datos de la fecha.</strong> Gestione las fechas en las que los docentes pueden realizar peticiones,quejas y reclamos sobre una productivad académica. Recuerde de que solo una fecha puede estar en estado ACTIVA.
                </div>
                <div class="col-md-12">
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        {!! Form::open(['route'=>['fechapqr.update',$fecha],'method'=>'PUT','class'=>'form-horizontal'])!!}
                        <div class="col-md-12">
                            <div class="col-md-12">
